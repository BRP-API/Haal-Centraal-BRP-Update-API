...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BeherenVolgindicatiesApi()
        api_instance.get_volgindicatie  # this is an instance of the class Endpoint
        api_instance.get_volgindicatie()  # this invokes api_instance.get_volgindicatie.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_volgindicatie.callable or self.callable in this class
