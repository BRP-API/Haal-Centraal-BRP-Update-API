...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VolgindicatieRaadplegen")]
    public partial class VolgindicatieRaadplegen : IEquatable<VolgindicatieRaadplegen>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VolgindicatieRaadplegen" /> class.
        /// </summary>
        ...
        public VolgindicatieRaadplegen(DateTime einddatum = default(DateTime), string burgerservicenummer = default(string))
        {
        ...
        {
            return this.Equals(input as VolgindicatieRaadplegen);
        }

        /// <summary>
        /// Returns true if VolgindicatieRaadplegen instances are equal
        /// </summary>
        /// <param name="input">Instance of VolgindicatieRaadplegen to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VolgindicatieRaadplegen input)
        {
            if (input == null)
                return false;
