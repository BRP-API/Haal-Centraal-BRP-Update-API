...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class BeherenVolgindicatiesApi : IBeherenVolgindicatiesApi
    {
        ...
        /// <param name="burgerservicenummer">Identificerend gegeven van een ingeschreven natuurlijk persoon, als bedoeld in artikel 1.1 van de Wet algemene bepalingen burgerservicenummer.</param>
        /// <returns>ApiResponse of VolgindicatieRaadplegen</returns>
        public Org.OpenAPITools.Client.ApiResponse< VolgindicatieRaadplegen > GetVolgindicatieWithHttpInfo (AnyType burgerservicenummer)
        {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<VolgindicatieRaadplegen> localVarResponse = await GetVolgindicatieAsyncWithHttpInfo(burgerservicenummer);
             return localVarResponse.Data;
        ...
        /// <param name="burgerservicenummer">Identificerend gegeven van een ingeschreven natuurlijk persoon, als bedoeld in artikel 1.1 van de Wet algemene bepalingen burgerservicenummer.</param>
        /// <returns>Task of ApiResponse (VolgindicatieRaadplegen)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<VolgindicatieRaadplegen>> GetVolgindicatieAsyncWithHttpInfo (AnyType burgerservicenummer)
        {
            // verify the required parameter 'burgerservicenummer' is set
            if (burgerservicenummer == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'burgerservicenummer' when calling BeherenVolgindicatiesApi->GetVolgindicatie");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VolgindicatieRaadplegen>("/volgindicaties/{burgerservicenummer}", localVarRequestOptions, this.Configuration);
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<VolgindicatieCollectie> localVarResponse = await GetVolgindicatiesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (VolgindicatieCollectie)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<VolgindicatieCollectie>> GetVolgindicatiesAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VolgindicatieCollectie>("/volgindicaties", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="volgindicatie"> (optional)</param>
        /// <returns>ApiResponse of VolgindicatieRaadplegen</returns>
        public Org.OpenAPITools.Client.ApiResponse< VolgindicatieRaadplegen > UpsertVolgindicatieWithHttpInfo (AnyType burgerservicenummer, Volgindicatie volgindicatie = default(Volgindicatie))
        {
            // verify the required parameter 'burgerservicenummer' is set
            if (burgerservicenummer == null)
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<VolgindicatieRaadplegen> localVarResponse = await UpsertVolgindicatieAsyncWithHttpInfo(burgerservicenummer, volgindicatie);
             return localVarResponse.Data;
        ...
        /// <param name="volgindicatie"> (optional)</param>
        /// <returns>Task of ApiResponse (VolgindicatieRaadplegen)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<VolgindicatieRaadplegen>> UpsertVolgindicatieAsyncWithHttpInfo (AnyType burgerservicenummer, Volgindicatie volgindicatie = default(Volgindicatie))
        {
            // verify the required parameter 'burgerservicenummer' is set
            if (burgerservicenummer == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'burgerservicenummer' when calling BeherenVolgindicatiesApi->UpsertVolgindicatie");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<VolgindicatieRaadplegen>("/volgindicaties/{burgerservicenummer}", localVarRequestOptions, this.Configuration);
