...
Functionaliteit: Als gebruiker wil ik wijzigingen kunnen opvragen van zowel binnengemeentelijke als buitengemeentelijke personen
    ...
    2. Wanneer geen enkele gebruiker een actieve volgindicatie op een buitengemeentelijke persoon, mag er geen actieve volgindicatie zijn voor deze persoon bij het GBA-V.
   ...
   Volgindicaties in GBA-V kunnen worden gewijzigd n.a.v.:
      ...
      - Een binnengemeentelijke wijziging (de update applicatie ontvangt van een StUF npsLk01 kennisgeving uit het burgerzakensysteem)
        - persoon is nu ingeschreven in deze gemeenten en applicatie ontvangt StUF mutatiesoort='V': uitverhuizing
        - persoon is nu ingeschreven in andere gemeenten en applicatie ontvangt StUF mutatiesoort≠'V' (normaliter 'T'): inverhuizing
 

   Scenario: Een gebruiker zet als eerste een volgindicatie op een binnengemeentelijk persoon
      ...
      Dan stuurt de applicatie GEEN Ap01 bericht met burgerservicenummer "999995066" naar het GBA-V 
   ...
   Scenario: Een gebruiker zet als eerste een volgindicatie op een buitengemeentelijk persoon
      ...
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "999993653" naar het GBA-V 
   ...
   Scenario: Een gebruiker zet als eerste een volgindicatie op een persoon met einddatum in de toekomst
      ...
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "999993483" naar het GBA-V
   ...
   Scenario: Een gebruiker zet een volgindicatie op een persoon die al gevolgd wordt door een andere gebruiker
      ...
      Dan stuurt de applicatie GEEN Ap01 bericht met burgerservicenummer "999990457" naar het GBA-V
   ...
   Scenario: Een gebruiker zet een volgindicatie op een persoon die niet meer gevolgd wordt door een andere gebruiker
      ...
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "999992855" naar het GBA-V
   ...
   Scenario: Een gebruiker verlengt de einddatum van de volgindicatie
      ...
      Dan stuurt de applicatie GEEN Ap01 bericht met burgerservicenummer "999992806" naar het GBA-V
   ...
   Scenario: Een gebruiker wijzigt de einddatum van de volgindicatie naar vandaag
      ...
      Dan stuurt de applicatie een Av01 bericht met burgerservicenummer "999994220" naar het GBA-V
   ...
   Scenario: Een gebruiker beëindigt de volgindicatie die ook voor alle andere gebruikers inactief is
      ...
      Dan stuurt de applicatie een Av01 bericht met burgerservicenummer "999992351" naar het GBA-V
   ...
   Scenario: Een gebruiker beëindigt de volgindicatie voor een persoon die ook door een andere gebruiker gevolgd wordt
      ...
      Dan stuurt de applicatie GEEN Av01 bericht met burgerservicenummer "999992971" naar het GBA-V
   ...
   Scenario: Een gebruiker heropent een beëindigde volgindicatie
      ...
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "000009945" naar het GBA-V
   ...
   Scenario: Een gebruiker heropent een beëindigde volgindicatie die eerder door een andere gebruiker gevolgd werd
      ...
      En de applicatie heeft op 1 maart 2021 een Av01 bericht met burgerservicenummer "999990949" naar het GBA-V gestuurd
      Als gebruiker "B" op 5 maart 2021 een volgindicatie zet op de persoon met burgerservicenummer "999990949" en geen einddatum
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "999990949" naar het GBA-V
   ...
   Scenario: De einddatum van een volgindicatie is vandaag voor een persoon die ook door een andere gebruiker gevolgd wordt
      ...
      Dan stuurt de applicatie GEEN Av01 bericht met burgerservicenummer "999990962" naar het GBA-V
   ...
   Scenario: De einddatum van een volgindicatie is vandaag en er zijn geen andere actieve volgindicaties op deze persoon
      ...
      Dan stuurt de applicatie een Av01 bericht met burgerservicenummer "999990962" naar het GBA-V
   ...
   Scenario: De einddatum van een volgindicatie is een datum in het verleden (Av01 wordt maar één keer gestuurd)
      ...
      En de applicatie heeft op 5 maart 2021 een Av01 bericht met burgerservicenummer "999990962" naar het GBA-V gestuurd
   ...
   Scenario: De persoon verhuist naar deze gemeente
      ...
      En gebruiker "B" heeft een volgindicatie voor de persoon met burgerservicenummer "999992971" en einddatum "2021-06-30"
      En de applicatie ontvangt binnengemeentelijke wijzigingen via StUF BG kennisgevingsberichten
      Als de applicatie op 5 maart 2021 een npsLk01 bericht met mutatiesoort "T" en burgerservicenummer "999992971" ontvangt
      Dan stuurt de applicatie een Av01 bericht met burgerservicenummer "999992971" naar het GBA-V
   ...
   Scenario: De persoon verhuist naar buiten deze gemeente
      ...
      En de applicatie ontvangt binnengemeentelijke wijzigingen via StUF BG kennisgevingsberichten
      Als de applicatie op 5 maart 2021 een npsLk01 bericht met mutatiesoort "V" en burgerservicenummer "999993847" ontvangt
      Dan stuurt de applicatie een Ap01 bericht met burgerservicenummer "999993847" naar het GBA-V
   ...
   Scenario: Een persoon die niet wordt gevolgd verhuist naar deze gemeente
      ...
      En de applicatie ontvangt binnengemeentelijke wijzigingen via StUF BG kennisgevingsberichten
      Als de applicatie op 5 maart 2021 een npsLk01 bericht met mutatiesoort "T" en burgerservicenummer "999992971" ontvangt
      Dan stuurt de applicatie GEEN Av01 bericht met burgerservicenummer "000009891" naar het GBA-V
   ...
   Scenario: Een persoon die niet wordt gevolgd verhuist naar buiten deze gemeente
      ...
      En de applicatie ontvangt binnengemeentelijke wijzigingen via StUF BG kennisgevingsberichten
      Als de applicatie op 5 maart 2021 een npsLk01 bericht met mutatiesoort "V" en burgerservicenummer "999992235" ontvangt
      Dan stuurt de applicatie GEEN Av01 bericht met burgerservicenummer "999992235" naar het GBA-V