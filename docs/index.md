...
Tips over hoe je de update API snel en slim in jouw gemeente aanbiedt, vind je in het filmpje [Snel in business met de Update API](https://youtu.be/3oJRzRJdQeA).
